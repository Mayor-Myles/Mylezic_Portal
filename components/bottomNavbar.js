...
<Text color="grey" fontSize="12px">{colorMode==="light" ? "Dark Mode" : "Light Mode"}</Text>
      ...
      <Box onClick={() => window.open(`https://wa.me/2347014443158?text=Hi%20Mylezic%20support%2C%20I%20need%20an%20assistant%20from%20you.%20My%20user%20id%20is%20${encodeURIComponent(user.userId)}`, '_blank')}>
  <IconButton
    aria-label="support"
