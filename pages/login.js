...
<Text fontSize="1.2em" fontWeight="bold">Login to your account</Text>
        ...
        <Text mt="0">Have no account? <Link color="teal" onClick={()=>router.push("/register")}>Register</Link></Text>
      </Flex>
      ...
      <Input onChange={(e) => setFormData((prev) =>({...prev,['user']:e.target.value}))} type="number" placeholder="Phone number" outline="none" bg="#F5F5F5" p="1.2em" border="0px" borderRadius="0.5em" size="lg" w="full" fontSize="14px" value={formData.user}/>
      ...
      <Input onChange={(e) => setFormData((prev) => ({...prev,['password']:e.target.value}))}  type={!passwordVisible ? "password" : "text"} placeholder="Password" outline="none" bg="#F5F5F5" p="1.2em" border="0px" borderRadius="0.5em" size="lg" w="full" fontSize="14px"/>
...
<Button isLoading={loading} onClick={submitForm} size="md" colorScheme="teal" bgg="teal" w="full">Continue</Button>
</Flex>
